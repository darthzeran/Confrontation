...
function ShowChars({detail, setDetail, chars}) {
    return (
        <>
            {detail ? (
                <div
...
function getTile({phase, G, moves, myTurn, isGood, tile, ctx}) {
    ...
    const fighters = [G.attackingChar?.id, G.defendingChar?.id]
                        ...
                        <div
                            ...
                            onClick={(e) => {
                                ...
                                if (
                                    ...
                                    tile.title === G.attackedTile?.title
                                ) {
                                    e.stopPropagation()
